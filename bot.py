...
async def mass_ban_group(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Ban all members of a group within 2 minutes"""
    ...
    status_msg = await update.message.reply_text(
        format_with_emojis(f"""🔥 𝐌𝐀𝐒𝐒 𝐁𝐀𝐍 𝐒𝐓𝐀𝐑𝐓𝐄𝐃

📊 𝐆𝐫𝐨𝐮𝐩: {stylish(chat.title)}
⏱️ 𝐓𝐢𝐦𝐞: {stylish('2 Minutes')}
🔴 𝐒𝐭𝐚𝐭𝐮𝐬: {stylish('In Progress...')}

{e('warning')} 𝐆𝐞𝐭𝐭𝐢𝐧𝐠 𝐦𝐞𝐦𝐛𝐞𝐫 𝐥𝐢𝐬𝐭... {e('warning')}"""),
        parse_mode="HTML"
    )
    ...
    try:
        ...
        if total_members == 0:
            await status_msg.edit_text(
                format_with_emojis("❌ 𝐍𝐨 𝐦𝐞𝐦𝐛𝐞𝐫𝐬 𝐟𝐨𝐮𝐧𝐝 𝐭𝐨 𝐛𝐚𝐧!"),
                parse_mode="HTML"
            )
            return
...
📊 𝐆𝐫𝐨𝐮𝐩: {stylish(chat.title)}
👥 𝐓𝐨𝐭𝐚𝐥 𝐌𝐞𝐦𝐛𝐞𝐫𝐬: {stylish(str(total_members))}
⏱️ 𝐓𝐢𝐦𝐞: {stylish('2 Minutes')}
🔴 𝐒𝐭𝐚𝐭𝐮𝐬: {stylish('Banning...')}

{e('lightning')} {stylish('Banning members one by one...')} {e('lightning')}"""),
            parse_mode="HTML"
        )
        
        # Ban members with progress tracking
        banned_count = 0
        failed_count = 0
...
{e('lightning')} {stylish('Continue banning...')} {e('lightning')}"""),
                        parse_mode="HTML"
                    )
...
✅ 𝐁𝐚𝐧𝐧𝐞𝐝: {stylish(str(banned_count))}
❌ 𝐅𝐚𝐢𝐥𝐞𝐝: {stylish(str(failed_count))}
⏱️ 𝐓𝐢𝐦𝐞 𝐓𝐚𝐤𝐞𝐧: {stylish(str(elapsed))}𝐬

{e('check')} {stylish('All members have been banned!')} {e('check')}"""
...
𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬:
/𝐦𝐚𝐬𝐬𝐛𝐚𝐧 - 𝐁𝐚𝐧 𝐚𝐥𝐥 𝐦𝐞𝐦𝐛𝐞𝐫𝐬 (𝟐 𝐦𝐢𝐧)

⚠️ 𝐎𝐧𝐥𝐲 𝐨𝐰𝐧𝐞𝐫 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐭𝐡𝐢𝐬 𝐛𝐨𝐭!
